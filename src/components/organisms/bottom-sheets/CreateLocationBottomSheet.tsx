...
export const CreateLocationBottomSheet: React.FC<
  CreateLocationBottomSheetProps
> = ({ bottomSheetRef, onLocationCreated, locationToEdit, onClose }) => {
  ...
  const renderFooter = useCallback(() => {
    const handleSubmit = async () => {
      ...
      try {
        ...
        setLocalError(
          locationToEdit
            ? t('locations.errors.updateFailed')
            : t('locations.errors.createFailed')
        );
      }
    };

    const isSubmitting = locationToEdit
      ? updatingLocationIds.includes(locationToEdit.id)
      : addingLocation;
    ...
    return (
      ...
      >
        ...
        <GlassButton
          text={
            locationToEdit
              ? t('locations.edit.submit')
              : t('locations.create.submit')
          }
    ...
    >
      <ContentContainer>
        <BottomSheetHeader
          ...
          subtitle={
            locationToEdit
              ? t('locations.edit.subtitle')
              : t('locations.create.subtitle')
          }
          onClose={handleClose}
        />
        <BottomSheetScrollView
