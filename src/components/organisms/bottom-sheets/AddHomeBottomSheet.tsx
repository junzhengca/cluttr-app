...
export const AddHomeBottomSheet: React.FC<AddHomeBottomSheetProps> = ({
  ...
  const titleKey = isRequired
    ? 'home.createRequired.title'
    : 'home.create.title';
  const subtitleKey = isRequired
    ? 'home.createRequired.subtitle'
    : 'home.create.subtitle';
  const nicknameLabelKey = isRequired
    ? 'home.createRequired.nicknameLabel'
    : 'home.create.nicknameLabel';
  const nicknamePlaceholderKey = isRequired
    ? 'home.createRequired.nicknamePlaceholder'
    : 'home.create.nicknamePlaceholder';
  const addressLabelKey = isRequired
    ? 'home.createRequired.addressLabel'
    : 'home.create.addressLabel';
  const addressPlaceholderKey = isRequired
    ? 'home.createRequired.addressPlaceholder'
    : 'home.create.addressPlaceholder';
  const submitKey = isRequired
    ? 'home.createRequired.submit'
    : 'home.create.submit';
  ...
  const isLoading =
    loadingState.operation === 'create' && loadingState.isLoading;
